...
>>> rr.to_partprogram_entity(entity_id=machine1.id).to_json()
'{"id": "urn:ngsi-ld:Machine:1", "type": "Machine", \
...
>>> ai = DurationEstimateEntity(id=machine1.id,
...                              cutting_duration=FloatAttr.new(2.3),
...                              duration=FloatAttr.new(4.5))
>>> ai.json()
